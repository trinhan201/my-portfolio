    ...
    return (
        <div id="skills" className="px-[36px] py-[72px] xl:p-[72px] bg-[#f1f5f8] dark:bg-[#131917]">
            ...
            <div className="flex flex-wrap justify-center gap-x-[30px] gap-y-[50px] xl:justify-between xl:gap-x-[80px] py-[24px] mt-[48px] select-none">
                <div className="relative w-[300px] h-[200px] shadow-custom rounded-lg border-b-[3px] border-[#ff5722] bg-[#fff]">
                ...
                <div className="relative w-[300px] h-[200px] shadow-custom rounded-lg border-b-[3px] border-[#1572b6] bg-[#fff]">
                ...
                <div className="relative w-[300px] h-[200px] shadow-custom rounded-lg border-b-[3px] border-[#ffdf00] bg-[#fff]">
                ...
                <div className="relative w-[300px] h-[200px] shadow-custom rounded-lg border-b-[3px] border-[#61d9fb] bg-[#fff]">
                ...
                <div className="relative w-[300px] h-[200px] shadow-custom rounded-lg border-b-[3px] border-[#000000] bg-[#fff]">
                ...
                <div className="relative w-[300px] h-[200px] shadow-custom rounded-lg border-b-[3px] border-[#f34f29] bg-[#fff]">
