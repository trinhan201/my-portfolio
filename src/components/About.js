...
function About() {
    return (
        <div id="about" className="px-[36px] py-[72px] xl:p-[72px]">
            ...
            <div className="flex flex-col gap-y-[50px] xl:flex-row xl:justify-between xl:gap-x-[100px] py-[24px] mt-[32px]">
                <div className="flex-1">
                    <h1 className="text-2xl font-semibold leading-10">Who Am I</h1>
                ...
                <div className="flex-1">
                    <h1 className="text-2xl font-semibold leading-10">Education</h1>
                    <p className="font-semibold text-xl">Information Technology</p>
                    <p className="opacity-80">Ton Duc Thang University</p>
